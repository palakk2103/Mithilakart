...
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/Analytics.jsx`
...
## Components
Primary page component: **Analytics.jsx**
See per-file audit: [files/](../../files/) — search for Analytics.jsx

## Business Flow
1. User navigates to `/seller/analytics`
