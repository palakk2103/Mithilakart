...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/UserReport.jsx`
...
## Components
Primary page component: **UserReport.jsx**
See per-file audit: [files/](../../files/) — search for UserReport.jsx

## Business Flow
1. User navigates to `/admin/reports/users`
