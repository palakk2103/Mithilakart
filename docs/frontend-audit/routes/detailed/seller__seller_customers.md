...
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/CustomerList.jsx`
...
## Purpose
Customer list for seller

## Components
Primary page component: **CustomerList.jsx**
See per-file audit: [files/](../../files/) — search for CustomerList.jsx

## Business Flow
1. User navigates to `/seller/customers`
