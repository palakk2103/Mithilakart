...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/Notifications.jsx`
...
## Components
Primary page component: **Notifications.jsx**
See per-file audit: [files/](../../files/) — search for Notifications.jsx

## Business Flow
1. User navigates to `/admin/comms/notifications`
