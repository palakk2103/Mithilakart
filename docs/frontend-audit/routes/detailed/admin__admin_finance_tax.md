...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/TaxConfig.jsx`
...
## Components
Primary page component: **TaxConfig.jsx**
See per-file audit: [files/](../../files/) — search for TaxConfig.jsx

## Business Flow
1. User navigates to `/admin/finance/tax`
