# Route: `/continue-shopping/:productId`

## Route
- **Path:** `/continue-shopping/:productId`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/ContinueShopping.jsx`
...
## Purpose
Post-product-view recommendations

## Components
Primary page component: **ContinueShopping.jsx**
See per-file audit: [files/](../../files/) — search for ContinueShopping.jsx

## Business Flow
1. User navigates to `/continue-shopping/:productId`
