...
- **Path:** `/terms`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/TermsOfUse.jsx`
...
## Components
Primary page component: **TermsOfUse.jsx**
See per-file audit: [files/](../../files/) — search for TermsOfUse.jsx
