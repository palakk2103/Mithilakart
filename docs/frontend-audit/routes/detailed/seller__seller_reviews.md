...
- **Path:** `/seller/reviews`
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/ReviewList.jsx`
...
## Components
Primary page component: **ReviewList.jsx**
See per-file audit: [files/](../../files/) — search for ReviewList.jsx

## Business Flow
1. User navigates to `/seller/reviews`
