...
- **Path:** `/shipping`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/ShippingPolicy.jsx`
...
## Components
Primary page component: **ShippingPolicy.jsx**
See per-file audit: [files/](../../files/) — search for ShippingPolicy.jsx

## Business Flow
1. User navigates to `/shipping`
