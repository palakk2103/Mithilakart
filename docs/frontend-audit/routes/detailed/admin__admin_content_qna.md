# Route: `/admin/content/qna`

## Route
- **Path:** `/admin/content/qna`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/QnAModeration.jsx`
...
## Components
Primary page component: **QnAModeration.jsx**
See per-file audit: [files/](../../files/) — search for QnAModeration.jsx

## Business Flow
1. User navigates to `/admin/content/qna`
