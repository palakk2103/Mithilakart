...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/VendorList.jsx`
...
## Components
Primary page component: **VendorList.jsx**
See per-file audit: [files/](../../files/) — search for VendorList.jsx

## Business Flow
1. User navigates to `/admin/vendors/all`
