...
- **Path:** `/delivery/about`
- **Module:** delivery
- **Component File:** `frontend/src/modules/delivery/pages/About.jsx`
...
## Components
Primary page component: **About.jsx**
See per-file audit: [files/](../../files/) — search for About.jsx

## Business Flow
1. User navigates to `/delivery/about`
