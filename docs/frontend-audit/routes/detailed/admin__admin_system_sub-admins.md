# Route: `/admin/system/sub-admins`

## Route
- **Path:** `/admin/system/sub-admins`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/SubAdmins.jsx`
...
## Components
Primary page component: **SubAdmins.jsx**
See per-file audit: [files/](../../files/) — search for SubAdmins.jsx

## Business Flow
1. User navigates to `/admin/system/sub-admins`
