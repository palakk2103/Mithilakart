...
- **Path:** `/profile`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Profile.jsx`
...
## Purpose
User profile hub with menu links

## Components
Primary page component: **Profile.jsx**
See per-file audit: [files/](../../files/) — search for Profile.jsx

## Business Flow
1. User navigates to `/profile`
2. Route guard checks: Public (no guard)
