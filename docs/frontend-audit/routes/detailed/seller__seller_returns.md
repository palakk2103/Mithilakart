...
- **Path:** `/seller/returns`
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/ReturnList.jsx`
...
## Components
Primary page component: **ReturnList.jsx**
See per-file audit: [files/](../../files/) — search for ReturnList.jsx

## Business Flow
1. User navigates to `/seller/returns`
