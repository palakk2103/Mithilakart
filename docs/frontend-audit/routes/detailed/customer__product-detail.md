...
- **Path:** `/product-detail`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/ProductDetail.jsx`
...
## Purpose
Single product view with add to cart/buy now

## Components
Primary page component: **ProductDetail.jsx**
See per-file audit: [files/](../../files/) — search for ProductDetail.jsx
