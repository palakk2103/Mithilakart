...
- **Path:** `/fresh-grocery`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/QuickShop.jsx`
...
## Purpose
Fresh grocery vertical entry

## Components
Primary page component: **QuickShop.jsx**
See per-file audit: [files/](../../files/) — search for QuickShop.jsx

## Business Flow
1. User navigates to `/fresh-grocery`
