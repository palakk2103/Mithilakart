...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/InventoryReport.jsx`
...
## Components
Primary page component: **InventoryReport.jsx**
See per-file audit: [files/](../../files/) — search for InventoryReport.jsx

## Business Flow
1. User navigates to `/admin/reports/inventory`
