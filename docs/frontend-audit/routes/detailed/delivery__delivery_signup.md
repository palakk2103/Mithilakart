# Route: `/delivery/signup`

## Route
- **Path:** `/delivery/signup`
- **Module:** delivery
- **Component File:** `frontend/src/modules/delivery/pages/Signup.jsx`
...
## Components
Primary page component: **Signup.jsx**
See per-file audit: [files/](../../files/) — search for Signup.jsx

## Business Flow
1. User navigates to `/delivery/signup`
