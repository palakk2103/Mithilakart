...
- **Path:** `/home`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Home.jsx`
...
## Purpose
Main storefront with CMS-driven home sections

## Components
Primary page component: **Home.jsx**
See per-file audit: [files/](../../files/) — search for Home.jsx
