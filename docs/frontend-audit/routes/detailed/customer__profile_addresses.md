...
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/SavedAddresses.jsx`
...
## Components
Primary page component: **SavedAddresses.jsx**
See per-file audit: [files/](../../files/) — search for SavedAddresses.jsx
