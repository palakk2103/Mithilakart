...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/InventoryList.jsx`
...
## Components
Primary page component: **InventoryList.jsx**
See per-file audit: [files/](../../files/) — search for InventoryList.jsx

## Business Flow
1. User navigates to `/admin/inventory/all`
