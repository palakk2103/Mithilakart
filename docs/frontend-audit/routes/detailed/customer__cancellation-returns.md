...
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/CancellationReturns.jsx`
...
## Components
Primary page component: **CancellationReturns.jsx**
See per-file audit: [files/](../../files/) — search for CancellationReturns.jsx

## Business Flow
1. User navigates to `/cancellation-returns`
