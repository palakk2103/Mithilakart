...
- **Module:** delivery
- **Component File:** `frontend/src/modules/delivery/pages/Support.jsx`
...
## Components
Primary page component: **Support.jsx**
See per-file audit: [files/](../../files/) — search for Support.jsx

## Business Flow
1. User navigates to `/delivery/support`
