# Route: `/delivery/profile/edit`

## Route
- **Path:** `/delivery/profile/edit`
- **Module:** delivery
- **Component File:** `frontend/src/modules/delivery/pages/PersonalInfo.jsx`
...
## Components
Primary page component: **PersonalInfo.jsx**
See per-file audit: [files/](../../files/) — search for PersonalInfo.jsx

## Business Flow
1. User navigates to `/delivery/profile/edit`
