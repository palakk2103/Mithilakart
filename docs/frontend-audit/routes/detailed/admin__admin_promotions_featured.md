# Route: `/admin/promotions/featured`

## Route
- **Path:** `/admin/promotions/featured`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/FeaturedProducts.jsx`
...
## Components
Primary page component: **FeaturedProducts.jsx**
See per-file audit: [files/](../../files/) — search for FeaturedProducts.jsx

## Business Flow
1. User navigates to `/admin/promotions/featured`
