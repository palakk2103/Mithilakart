...
## Route
- **Path:** `/admin/products/moderation`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/ProductModeration.jsx`
...
## Components
Primary page component: **ProductModeration.jsx**
See per-file audit: [files/](../../files/) — search for ProductModeration.jsx

## Business Flow
1. User navigates to `/admin/products/moderation`
