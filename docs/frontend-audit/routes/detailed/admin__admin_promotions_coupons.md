# Route: `/admin/promotions/coupons`

## Route
- **Path:** `/admin/promotions/coupons`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/Coupons.jsx`
...
## Components
Primary page component: **Coupons.jsx**
See per-file audit: [files/](../../files/) — search for Coupons.jsx

## Business Flow
1. User navigates to `/admin/promotions/coupons`
