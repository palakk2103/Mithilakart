...
- **Path:** `/categories`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Categories.jsx`
...
## Components
Primary page component: **Categories.jsx**
See per-file audit: [files/](../../files/) — search for Categories.jsx
