...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/RoleManagement.jsx`
...
## Components
Primary page component: **RoleManagement.jsx**
See per-file audit: [files/](../../files/) — search for RoleManagement.jsx

## Business Flow
1. User navigates to `/admin/system/roles`
