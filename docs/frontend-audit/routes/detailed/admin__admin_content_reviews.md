...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/ReviewModeration.jsx`
...
## Components
Primary page component: **ReviewModeration.jsx**
See per-file audit: [files/](../../files/) — search for ReviewModeration.jsx

## Business Flow
1. User navigates to `/admin/content/reviews`
