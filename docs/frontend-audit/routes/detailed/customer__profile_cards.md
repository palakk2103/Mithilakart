...
- **Path:** `/profile/cards`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/SavedCards.jsx`
...
## Components
Primary page component: **SavedCards.jsx**
See per-file audit: [files/](../../files/) — search for SavedCards.jsx

## Business Flow
1. User navigates to `/profile/cards`
