...
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/HelpCenter.jsx`
...
## Components
Primary page component: **HelpCenter.jsx**
See per-file audit: [files/](../../files/) — search for HelpCenter.jsx

## Business Flow
1. User navigates to `/profile/help-center`
