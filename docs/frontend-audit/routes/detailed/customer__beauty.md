...
- **Path:** `/beauty`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/BeautyLanding.jsx`
...
## Purpose
Beauty category landing

## Components
Primary page component: **BeautyLanding.jsx**
See per-file audit: [files/](../../files/) — search for BeautyLanding.jsx

## Business Flow
1. User navigates to `/beauty`
