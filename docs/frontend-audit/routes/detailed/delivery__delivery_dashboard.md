...
- **Module:** delivery
- **Component File:** `frontend/src/modules/delivery/pages/Dashboard.jsx`
...
## Components
Primary page component: **Dashboard.jsx**
See per-file audit: [files/](../../files/) — search for Dashboard.jsx

## Business Flow
1. User navigates to `/delivery/dashboard`
