...
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/ForgotPassword.jsx`
...
## Components
Primary page component: **ForgotPassword.jsx**
See per-file audit: [files/](../../files/) — search for ForgotPassword.jsx
