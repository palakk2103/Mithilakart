...
- **Path:** `/privacy`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/PrivacyPolicy.jsx`
...
## Components
Primary page component: **PrivacyPolicy.jsx**
See per-file audit: [files/](../../files/) — search for PrivacyPolicy.jsx
