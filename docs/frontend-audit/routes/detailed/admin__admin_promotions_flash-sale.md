# Route: `/admin/promotions/flash-sale`

## Route
- **Path:** `/admin/promotions/flash-sale`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/FlashSale.jsx`
...
## Components
Primary page component: **FlashSale.jsx**
See per-file audit: [files/](../../files/) — search for FlashSale.jsx

## Business Flow
1. User navigates to `/admin/promotions/flash-sale`
