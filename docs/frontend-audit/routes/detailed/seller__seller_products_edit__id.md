# Route: `/seller/products/edit/:id`

## Route
- **Path:** `/seller/products/edit/:id`
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/AddProduct.jsx`
...
## Components
Primary page component: **AddProduct.jsx**
See per-file audit: [files/](../../files/) — search for AddProduct.jsx

## Business Flow
1. User navigates to `/seller/products/edit/:id`
