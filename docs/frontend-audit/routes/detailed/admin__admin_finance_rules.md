# Route: `/admin/finance/rules`

## Route
- **Path:** `/admin/finance/rules`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/Rules.jsx`
...
## Components
Primary page component: **Rules.jsx**
See per-file audit: [files/](../../files/) — search for Rules.jsx

## Business Flow
1. User navigates to `/admin/finance/rules`
