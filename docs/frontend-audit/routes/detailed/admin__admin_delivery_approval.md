# Route: `/admin/delivery/approval`

## Route
- **Path:** `/admin/delivery/approval`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/DeliveryApproval.jsx`
...
## Components
Primary page component: **DeliveryApproval.jsx**
See per-file audit: [files/](../../files/) — search for DeliveryApproval.jsx

## Business Flow
1. User navigates to `/admin/delivery/approval`
