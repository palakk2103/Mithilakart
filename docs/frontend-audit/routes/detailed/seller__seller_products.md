...
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/ProductList.jsx`
...
## Components
Primary page component: **ProductList.jsx**
See per-file audit: [files/](../../files/) — search for ProductList.jsx
