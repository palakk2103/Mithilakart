# Route: `/admin/storefront/sections/:section`

## Route
- **Path:** `/admin/storefront/sections/:section`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/HomeSectionsManager.jsx`
...
## Purpose
Home page section curation

## Components
Primary page component: **HomeSectionsManager.jsx**
See per-file audit: [files/](../../files/) — search for HomeSectionsManager.jsx

## Business Flow
1. User navigates to `/admin/storefront/sections/:section`
