...
- **Path:** `/cart`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Cart.jsx`
...
## Purpose
Shopping cart with address modal and checkout CTA

## Components
Primary page component: **Cart.jsx**
See per-file audit: [files/](../../files/) — search for Cart.jsx
