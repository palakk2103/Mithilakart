...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/CustomerDetail.jsx`
...
## Components
Primary page component: **CustomerDetail.jsx**
See per-file audit: [files/](../../files/) — search for CustomerDetail.jsx

## Business Flow
1. User navigates to `/admin/users/:userId`
