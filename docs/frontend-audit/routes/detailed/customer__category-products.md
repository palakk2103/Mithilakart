...
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/CategoryProducts.jsx`
...
## Components
Primary page component: **CategoryProducts.jsx**
See per-file audit: [files/](../../files/) — search for CategoryProducts.jsx

## Business Flow
1. User navigates to `/category-products`
