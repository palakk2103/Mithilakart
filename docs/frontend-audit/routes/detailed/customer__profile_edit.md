...
- **Path:** `/profile/edit`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/EditProfile.jsx`
...
## Components
Primary page component: **EditProfile.jsx**
See per-file audit: [files/](../../files/) — search for EditProfile.jsx
