# Route: `/admin/operations/refunds`

## Route
- **Path:** `/admin/operations/refunds`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/Refunds.jsx`
...
## Purpose
Refund processing hub

## Components
Primary page component: **Refunds.jsx**
See per-file audit: [files/](../../files/) — search for Refunds.jsx

## Business Flow
1. User navigates to `/admin/operations/refunds`
