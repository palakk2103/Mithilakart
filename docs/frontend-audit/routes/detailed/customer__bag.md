...
- **Path:** `/bag`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Bag.jsx`
...
## Purpose
Alternative bag view

## Components
Primary page component: **Bag.jsx**
See per-file audit: [files/](../../files/) — search for Bag.jsx

## Business Flow
1. User navigates to `/bag`
