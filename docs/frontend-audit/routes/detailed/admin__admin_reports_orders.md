...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/OrderReport.jsx`
...
## Components
Primary page component: **OrderReport.jsx**
See per-file audit: [files/](../../files/) — search for OrderReport.jsx

## Business Flow
1. User navigates to `/admin/reports/orders`
