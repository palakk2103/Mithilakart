...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/StockAlerts.jsx`
...
## Components
Primary page component: **StockAlerts.jsx**
See per-file audit: [files/](../../files/) — search for StockAlerts.jsx

## Business Flow
1. User navigates to `/admin/inventory/alerts`
