...
- **Module:** delivery
- **Component File:** `frontend/src/modules/delivery/pages/Earnings.jsx`
...
## Components
Primary page component: **Earnings.jsx**
See per-file audit: [files/](../../files/) — search for Earnings.jsx

## Business Flow
1. User navigates to `/delivery/earnings`
