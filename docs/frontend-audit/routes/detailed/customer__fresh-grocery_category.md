# Route: `/fresh-grocery/category`

## Route
- **Path:** `/fresh-grocery/category`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/QuickShopSubcategory.jsx`
...
## Purpose
Grocery subcategory products

## Components
Primary page component: **QuickShopSubcategory.jsx**
See per-file audit: [files/](../../files/) — search for QuickShopSubcategory.jsx

## Business Flow
1. User navigates to `/fresh-grocery/category`
