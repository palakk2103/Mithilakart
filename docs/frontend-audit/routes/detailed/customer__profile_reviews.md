...
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/MyReviews.jsx`
...
## Components
Primary page component: **MyReviews.jsx**
See per-file audit: [files/](../../files/) — search for MyReviews.jsx

## Business Flow
1. User navigates to `/profile/reviews`
