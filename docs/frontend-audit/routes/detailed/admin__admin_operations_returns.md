...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/Returns.jsx`
...
## Components
Primary page component: **Returns.jsx**
See per-file audit: [files/](../../files/) — search for Returns.jsx

## Business Flow
1. User navigates to `/admin/operations/returns`
