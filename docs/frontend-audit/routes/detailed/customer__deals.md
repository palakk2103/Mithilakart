...
- **Path:** `/deals`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/DealsPage.jsx`
...
## Purpose
Deals and offers listing

## Components
Primary page component: **DealsPage.jsx**
See per-file audit: [files/](../../files/) — search for DealsPage.jsx
