...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/SellerReport.jsx`
...
## Components
Primary page component: **SellerReport.jsx**
See per-file audit: [files/](../../files/) — search for SellerReport.jsx

## Business Flow
1. User navigates to `/admin/reports/sellers`
