# Route: `/admin/finance/delivery-charges`

## Route
- **Path:** `/admin/finance/delivery-charges`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/DeliveryCharges.jsx`
...
## Components
Primary page component: **DeliveryCharges.jsx**
See per-file audit: [files/](../../files/) — search for DeliveryCharges.jsx

## Business Flow
1. User navigates to `/admin/finance/delivery-charges`
