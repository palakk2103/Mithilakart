...
- **Path:** `/seller/coupons`
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/CouponList.jsx`
...
## Components
Primary page component: **CouponList.jsx**
See per-file audit: [files/](../../files/) — search for CouponList.jsx

## Business Flow
1. User navigates to `/seller/coupons`
