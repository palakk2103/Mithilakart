...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/SellerDetail.jsx`
...
## Purpose
Vendor detail and KYC

## Components
Primary page component: **SellerDetail.jsx**
See per-file audit: [files/](../../files/) — search for SellerDetail.jsx

## Business Flow
1. User navigates to `/admin/vendors/:vendorId`
