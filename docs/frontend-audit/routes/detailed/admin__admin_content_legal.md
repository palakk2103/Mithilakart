# Route: `/admin/content/legal`

## Route
- **Path:** `/admin/content/legal`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/LegalPolicies.jsx`
...
## Components
Primary page component: **LegalPolicies.jsx**
See per-file audit: [files/](../../files/) — search for LegalPolicies.jsx

## Business Flow
1. User navigates to `/admin/content/legal`
