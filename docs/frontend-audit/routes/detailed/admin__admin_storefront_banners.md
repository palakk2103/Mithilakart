# Route: `/admin/storefront/banners`

## Route
- **Path:** `/admin/storefront/banners`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/BannerManager.jsx`
...
## Components
Primary page component: **BannerManager.jsx**
See per-file audit: [files/](../../files/) — search for BannerManager.jsx

## Business Flow
1. User navigates to `/admin/storefront/banners`
