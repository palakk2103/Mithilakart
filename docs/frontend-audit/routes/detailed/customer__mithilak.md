...
- **Path:** `/mithilak`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Mithilak.jsx`
...
## Purpose
Mithila art specialty store

## Components
Primary page component: **Mithilak.jsx**
See per-file audit: [files/](../../files/) — search for Mithilak.jsx

## Business Flow
1. User navigates to `/mithilak`
