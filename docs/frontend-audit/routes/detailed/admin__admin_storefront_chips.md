# Route: `/admin/storefront/chips`

## Route
- **Path:** `/admin/storefront/chips`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/CategoryChipsManager.jsx`
...
## Components
Primary page component: **CategoryChipsManager.jsx**
See per-file audit: [files/](../../files/) — search for CategoryChipsManager.jsx

## Business Flow
1. User navigates to `/admin/storefront/chips`
