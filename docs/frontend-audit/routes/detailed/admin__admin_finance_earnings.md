...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/PlatformEarnings.jsx`
...
## Components
Primary page component: **PlatformEarnings.jsx**
See per-file audit: [files/](../../files/) — search for PlatformEarnings.jsx

## Business Flow
1. User navigates to `/admin/finance/earnings`
