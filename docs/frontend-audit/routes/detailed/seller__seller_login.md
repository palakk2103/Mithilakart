...
- **Path:** `/seller/login`
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/SellerLogin.jsx`
...
## Components
Primary page component: **SellerLogin.jsx**
See per-file audit: [files/](../../files/) — search for SellerLogin.jsx
