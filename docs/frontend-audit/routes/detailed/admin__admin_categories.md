...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/CategoryManager.jsx`
...
## Components
Primary page component: **CategoryManager.jsx**
See per-file audit: [files/](../../files/) — search for CategoryManager.jsx

## Business Flow
1. User navigates to `/admin/categories`
