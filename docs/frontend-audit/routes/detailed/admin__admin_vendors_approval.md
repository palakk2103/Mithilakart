# Route: `/admin/vendors/approval`

## Route
- **Path:** `/admin/vendors/approval`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/VendorApproval.jsx`
...
## Components
Primary page component: **VendorApproval.jsx**
See per-file audit: [files/](../../files/) — search for VendorApproval.jsx

## Business Flow
1. User navigates to `/admin/vendors/approval`
