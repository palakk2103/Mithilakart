...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/AuditLogs.jsx`
...
## Components
Primary page component: **AuditLogs.jsx**
See per-file audit: [files/](../../files/) — search for AuditLogs.jsx

## Business Flow
1. User navigates to `/admin/system/audit-logs`
