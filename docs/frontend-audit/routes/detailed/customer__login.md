...
- **Path:** `/login`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Login.jsx`
...
## Purpose
OTP-based authentication via phone or email

## Components
Primary page component: **Login.jsx**
See per-file audit: [files/](../../files/) — search for Login.jsx
