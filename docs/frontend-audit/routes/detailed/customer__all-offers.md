...
- **Path:** `/all-offers`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/AllOffers.jsx`
...
## Components
Primary page component: **AllOffers.jsx**
See per-file audit: [files/](../../files/) — search for AllOffers.jsx

## Business Flow
1. User navigates to `/all-offers`
