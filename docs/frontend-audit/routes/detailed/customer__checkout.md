...
- **Path:** `/checkout`
- **Module:** customer
- **Component File:** `frontend/src/modules/user/pages/Checkout.jsx`
...
## Components
Primary page component: **Checkout.jsx**
See per-file audit: [files/](../../files/) — search for Checkout.jsx

## Business Flow
1. User navigates to `/checkout`
2. Route guard checks: Auth (localStorage)
