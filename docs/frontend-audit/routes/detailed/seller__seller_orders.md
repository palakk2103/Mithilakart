...
- **Path:** `/seller/orders`
- **Module:** seller
- **Component File:** `frontend/src/modules/seller/pages/OrderList.jsx`
...
## Components
Primary page component: **OrderList.jsx**
See per-file audit: [files/](../../files/) — search for OrderList.jsx

## Business Flow
1. User navigates to `/seller/orders`
