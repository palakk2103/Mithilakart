...
- **Path:** `/delivery/auth`
- **Module:** delivery
- **Component File:** `frontend/src/modules/delivery/pages/Auth.jsx`
...
## Components
Primary page component: **Auth.jsx**
See per-file audit: [files/](../../files/) — search for Auth.jsx

## Business Flow
1. User navigates to `/delivery/auth`
