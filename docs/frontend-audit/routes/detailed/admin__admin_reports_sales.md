...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/SalesReport.jsx`
...
## Components
Primary page component: **SalesReport.jsx**
See per-file audit: [files/](../../files/) — search for SalesReport.jsx

## Business Flow
1. User navigates to `/admin/reports/sales`
