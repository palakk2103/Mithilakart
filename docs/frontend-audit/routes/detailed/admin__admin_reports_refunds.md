...
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/RefundReport.jsx`
...
## Components
Primary page component: **RefundReport.jsx**
See per-file audit: [files/](../../files/) — search for RefundReport.jsx

## Business Flow
1. User navigates to `/admin/reports/refunds`
