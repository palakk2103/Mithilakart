# Route: `/admin/delivery/all`

## Route
- **Path:** `/admin/delivery/all`
- **Module:** admin
- **Component File:** `frontend/src/modules/admin/pages/AllDeliveries.jsx`
...
## Components
Primary page component: **AllDeliveries.jsx**
See per-file audit: [files/](../../files/) — search for AllDeliveries.jsx

## Business Flow
1. User navigates to `/admin/delivery/all`
